...
-- 01032000218DD800013875010C63080000005A000003E80000005900000CCB000013881BC2..101

function string.insert(str1, str2, pos)
    return str1:sub(1, pos) .. str2 .. str1:sub(pos + 1)
end
--string.insert("2345", ".", 2)
...
function DataToAlinkjson(datain)
    local params = {}
...
DataToAlinkjson("252513450421000")
DataToAlinkjson("11101032000218DD800013875010C63080000005A000003E80000005900000CCB000013881BC2")
